program sphexp_global_grid_2
  ...
  real(dp) :: rdate,rfilt,lat,lon,sigma,ran,fun,ran2, & 
              sigma_ran,sigma0,theta,phi,am,dth,dph,lambda,amp,fac,res
  ...
  if(narg == 0 .or. narg .ne. 2)then
     ...
     print *, '======================================================'
     print *, ''
     print *, ' inputs: [coef file] [res]'
     print *, ''
     print *, ' input coef format of Davids other codes'
     print *, ''
     print *, ' res in degrees'
     print *, ''
...
end program sphexp_global_grid_2
