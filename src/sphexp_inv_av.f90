program sphexp_inv_av
  ...
  integer(i4b) :: narg,ndata,ierr,lmax,ios,idata,ncoef, & 
                  ...
                  ilm1,ilm2,l2,l1,m1,m2,lmax_exp,lmax_av
  ...
  real(dp), dimension(:), allocatable :: lata,lona,funa,sigmaa,funa_syn,lambdaa
  ...
  if(narg == 0 .or. narg .ne. 6) then
     ...
     print *, ' NB. Think this version was built to implement a '
     print *, ' spatial resolution that we ended up not using. '
     print *, '======================================================'
     print *, ''
     ...
     print *, ''
     print *, ' -- data file should have the format: lat lon fun sigma lambda'
     ...
     print *, ''
     print *, ' -- lmax_exp == maximum degree for expanding the solution'
     print *, ''
     print *, '======================================================'
     stop
  end if
  ...
  call least_squares_fit_SH_av(ndata,lmin,lmax,lata,lona,funa, & 
                               sigmaa,lambdaa,nu1,nu2,flm,chi, & 
                               resmat = resmat,covm = covm,    & 
                               funa_syn = funa_syn)
